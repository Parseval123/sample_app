...
class UserTest < ActiveSupport::TestCase
  ...
  valid_addresses = %w[user@example.com USER@foo.COM A_US-ER@foo.bar.org first.last@foo.jp alice+bob@buzz.cn]
  ...
  invalid_addresses = %w[user@example,com user_@_foo.org user.name@example.foo@bar_bazz.com foo@bar+bazz.com]
